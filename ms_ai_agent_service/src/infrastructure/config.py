...
class Settings(BaseSettings):
    SERVICE_NAME: str = "ms_ai_agent_service"
    SERVICE_TITLE: str = "AI Agent Service"
    SERVICE_DESCRIPTION: str = "Servicio de agente IA para tutor virtual, preguntas y res̼menes."
