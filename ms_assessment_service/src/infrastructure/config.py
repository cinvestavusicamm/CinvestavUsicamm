...
class Settings(BaseSettings):
    SERVICE_NAME: str = "ms_assessment_service"
    SERVICE_TITLE: str = "Assessment Service"
    SERVICE_DESCRIPTION: str = "Servicio de evaluaciones: calificaciones, exÃ¡menes, actividades y reportes."
