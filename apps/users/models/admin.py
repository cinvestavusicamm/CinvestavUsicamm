...
from . import (
    ...
    ProcesoEscalafon, Document, Prom, ProcesoAprobacionCursos, RetroalimentacionIaCurso
)
...
admin.site.register(ProcesoAprobacionCursos)
admin.site.register(RetroalimentacionIaCurso)