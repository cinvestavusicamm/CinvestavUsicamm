...
from apps.users.views.administrador.admin_users_views import crear_admin
...
from apps.users.api.admin import listar_tablas_bd

app_name = "administrador"

urlpatterns = [
    path("dashboard/", panel_admin, name="panel_admin"),
