#!/usr/bin/env python3
# scripts/cargar_conocimiento_docente_fixed.py
...
# Forzar la variable DATABASE_URL
os.environ['DATABASE_URL'] = 'postgresql://postgres.ksdemhxapuhtmlgoknqw:admin_agent2025@aws-0-us-west-2.pooler.supabase.com:6543/postgres'
...
async def cargar_documentos():
    ...
    # Configurar servicios con modelo correcto
    try:
        # Forzamos el modelo correcto
        llm = OllamaAdapter()
        # Sobrescribimos el modelo de embeddings
        llm.embed_model = "nomic-embed-text"
        logger.info(f"✅ OllamaAdapter configurado con modelo: {llm.embed_model}")
